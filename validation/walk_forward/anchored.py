"""
Anchored Window Walk-Forward Fold Generator for Walk-Forward OS.
Fixed training start date with moving validation/test windows.
"""
...
class AnchoredWindowGenerator:
    """Generates anchored-window walk-forward fold definitions."""
    ...
    def generate_folds(
        ...
        while current_train_end + purge_period + val_size + embargo_period + test_size <= n:
            ...
            w = ValidationWindow(
                window_id=f"FOLD-ANC-{fold_idx:03d}",
                fold_index=fold_idx,
