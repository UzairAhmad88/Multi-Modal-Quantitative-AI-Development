...
- **24-Page Quant Workspace**: Streamlit dashboard workspace (`dashboard/`) covering Overview, Market, News/NLP, Fundamentals, Predictions, Signals, Portfolio, Risk, Backtesting, Experiments, MLOps Registry, Paper Trading, Research Validation, Research Orchestration, Research Intelligence, Model Factory, and **Quantitative Data Platform OS**.
- **FastAPI REST Backend**: REST API endpoints serving market data, news, fundamentals, features, predictions, signals, risk metrics, portfolio allocations, MLOps registry, paper trading controls, research orchestration, research intelligence, model factory, and data platform lifecycle.
